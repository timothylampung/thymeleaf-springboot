...
//  private long dtUserAccessLevel;
    ...
    private boolean dtUserActiveStatus;
    ...
    public UserImpl(String dtUserName, String dtUserContact, String dtUserEmail, String dtUserPassword, boolean dtUserActiveStatus, Set<RoleImpl> roles) {
...
//  }
    ...
    public boolean getDtUserActiveStatus() {
        return dtUserActiveStatus;
    }

    public void setDtUserActiveStatus(boolean dtUserActiveStatus) {
        this.dtUserActiveStatus = dtUserActiveStatus;
    }
